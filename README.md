...
| Действие | Когда |
|----------|--------|
| Поставить jar **v0.2.5+** (патчи через **0096**) | libjf / WorldWeaver не FATAL; NeoForge-клиент проходит config handshake |
...
Активные server-патчи: Folia `0001`–`0019`, NeoForge/Eturlia `0020`–`0096` (ASIC BLOCK bridges 0084–0086, amendments/TF/Moonlight/quality_food 0087–0093, Main.main+LevelStorageSource для libjf/WorldWeaver 0094, NeoForge config handshake 0095–0096, datapack/Create/Sable и др.).  
...
| Action | When |
|--------|------|
| Install jar **v0.2.5+** (patches through **0096**) | libjf / WorldWeaver no FATAL; NeoForge client config handshake |
...
Active server patches: Folia `0001`–`0019`, NeoForge/Eturlia `0020`–`0096` (ASIC BLOCK bridges 0084–0086, amendments/TF/Moonlight/quality_food 0087–0093, Main.main+LevelStorageSource for libjf/WorldWeaver 0094, NeoForge config handshake 0095–0096, datapack/Create/Sable, and more).  
